...
def sample_aws_with_network():
    ...
    return pd.DataFrame({
        ...
        'lineitem_productcode': ['AmazonEC2', 'AmazonEC2', 'AmazonEC2', 'AmazonEBS'],
        'product_productfamily': ['Data Transfer', 'Data Transfer', 'Compute Instance', 'Storage'],
...
class TestNetworkCostHandler:
    ...
    def test_attribute_network_costs_grouping_by_node_and_direction(self, mock_config):
        ...
        network_df = pd.DataFrame({
            'lineitem_resourceid': ['i-node1-suffix', 'i-node1-suffix', 'i-node2-suffix'],
