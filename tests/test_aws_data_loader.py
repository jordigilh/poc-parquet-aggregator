...
def sample_aws_cur_data():
    ...
    return pd.DataFrame({
        ...
        'lineitem_usageaccountid': ['123456789012', '123456789012', '123456789012', '123456789012'],
        'lineitem_productcode': ['AmazonEC2', 'AmazonEBS', 'AmazonEC2', 'AmazonVPC'],
        'lineitem_usagetype': ['BoxUsage:m5.large', 'EBS:VolumeUsage', 'BoxUsage:t3.micro', 'VPC-In-Bytes'],
        'product_instancetype': ['m5.large', '', 't3.micro', ''],
        'product_region': ['us-east-1', 'us-east-1', 'us-west-2', 'us-east-1'],
        'product_productfamily': ['Compute Instance', 'Storage', 'Compute Instance', 'Network'],
...
class TestAWSDataLoader:
    ...
    def test_large_resourcetags_json(self, mock_config):
        ...
        with patch('src.aws_data_loader.ParquetReader') as mock_reader_class:
            ...
            for i in range(150):
                data[f'resourceTags/user:tag-key-{i}'] = [f'tag-value-{i}', f'tag-value-{i}']
