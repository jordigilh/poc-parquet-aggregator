...
class TestStorageIntegration:
    ...
    def test_storage_without_pod_match_still_produces_output(
...
class TestStoragePodCombinedOutput:
    ...
    def test_combined_output_schema_is_consistent(
        ...
        core_columns = {
            ...
            'cluster_id', 'source_uuid', 'pod_labels'
        }
    ...
    def test_no_duplicate_keys_in_combined_output(
        ...
        key_cols = ['usage_start', 'namespace', 'data_source', 'pod', 'persistentvolumeclaim']
