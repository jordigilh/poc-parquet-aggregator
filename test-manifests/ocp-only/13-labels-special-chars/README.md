# Scenario 13: lauels special chars
...
nise report ocp -s 2025-10-01 -e 2025-10-02 \
  ...
  -w test-manifests/ocp-only/13-labels-special-chars/manifest.yml
...
python scripts/validate_ocp_totals.py \
  test-manifests/ocp-only/13-labels-special-chars/manifest.yml
```
