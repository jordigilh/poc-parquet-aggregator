# Scenario 07: unallocated capacity
...
nise report ocp -s 2025-10-01 -e 2025-10-02 \
  ...
  -w test-manifests/ocp-only/07-unallocated-capacity/manifest.yml
...
python scripts/validate_ocp_totals.py \
  test-manifests/ocp-only/07-unallocated-capacity/manifest.yml
```
